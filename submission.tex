...
\begin{figure}[h]
\centering
\includegraphics[scale=0.25]{outputs/part_4/initial-contour}
\caption{$\alpha^{(0)}$ Contour Plot}
\label{fig:}
\end{figure}
...
\begin{minipage}{.5\textwidth}
  \centering
\includegraphics[scale=0.25]{outputs/part_4/rcpga-contour}
\caption{RCPGA Contour Plot}
\label{fig:}
\end{minipage}%
\begin{minipage}{.5\textwidth}
  \centering
\includegraphics[scale=0.25]{outputs/part_4/fista-contour}
...
\begin{minipage}{.5\textwidth}
  \centering
\includegraphics[scale=0.4]{outputs/part_4/rcpga-loss}
\caption{RCPGA Loss}
\label{fig:}
\end{minipage}%
\begin{minipage}{.5\textwidth}
  \centering
\includegraphics[scale=0.4]{outputs/part_4/fista-loss}
\caption{FISTA Loss}
\label{fig:}
\end{minipage}
\end{figure}
